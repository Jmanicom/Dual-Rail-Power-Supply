...
(library Library_1
	...
	(compDef "ADP7102ARDZ-R7" (originalName "ADP7102ARDZ-R7") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "EN/UVLO") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.arrow.com/en/products/adp7102ardz-r7/analog-devices?region=nac")
		(attr "Height" "1.75 mm")
	)
