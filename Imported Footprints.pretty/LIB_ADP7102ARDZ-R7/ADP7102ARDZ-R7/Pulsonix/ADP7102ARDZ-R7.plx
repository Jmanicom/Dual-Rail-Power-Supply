...
//13712137/1211624/2.50/9/3/Integrated Circuit
...
(library Library_1
	...
	(padStyleDef "r309.8_241"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 2.41) (shapeHeight 3.098))
		(padShape (layerNumRef 16) (padShapeType Ellipse)  (shapeWidth 0) (shapeHeight 0))
	)
	(textStyleDef "Normal"
		(font
	...
	(patternDef "SOIC127P600X175-9N" (originalName "SOIC127P600X175-9N")
		(multiLayer
			...
			(pad (padNum 9) (padStyleRef r309.8_241) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "ADP7102ARDZ-R7" (originalName "ADP7102ARDZ-R7")
	...
	(compDef "ADP7102ARDZ-R7" (originalName "ADP7102ARDZ-R7") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "5" (pinName "EN/UVLO") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADP7102ARDZ-R7"))
		...
		(attr "Manufacturer_Part_Number" "ADP7102ARDZ-R7")
		(attr "Mouser Part Number" "584-ADP7102ARDZ-R7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/ADP7102ARDZ-R7?qs=WIvQP4zGanhyecxhoOTYew%3D%3D")
		(attr "Arrow Part Number" "ADP7102ARDZ-R7")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/adp7102ardz-r7/analog-devices?region=nac")
		(attr "Description" "Linear Voltage Regulators 300mA HV LDO")
		(attr "<Hyperlink>" "https://www.arrow.com/en/products/adp7102ardz-r7/analog-devices?region=nac")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ADP7102ARDZ-R7.stp")
